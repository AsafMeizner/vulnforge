...
- **Team → Private**: the row stops being pushed from your desktop. Other team members _still have it_ from their own sync cursors; you'd need an admin to delete it server-side if you want it gone for everyone.
