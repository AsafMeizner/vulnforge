...
router.get('/examples', (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/patterns/run', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/validate-poc', async (req: Request, res: Response, next: NextFunction) => {
  try {
